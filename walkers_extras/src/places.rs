...
#[derive(Clone)]
pub struct GroupedPlacesTree<T: Place, G: Group, P: Projection> {
    places: Arc<Vec<T>>,
    group: Arc<G>,
    projection: P,
...
impl<T: Place, G: Group, P: Projection> GroupedPlacesTree<T, G, P> {
    pub fn new(places: Vec<T>, group: G, projection: P) -> Self {
